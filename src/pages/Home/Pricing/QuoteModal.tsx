...
function calcInfra(checked: Set<string>): number {
              ...
              <div className="qm__tier-tabs">
                {MONTHLY_TIERS.map(tr => (
                  <button
                    ...
                    type="button"
                  >
                    <span className="qm__tier-tab__label">{t(`qm_tier_${tr.id}_label`)}</span>
                    <span className="qm__tier-tab__price">
            ...
            <div className="qm__price-bar">
              <div className="qm__price-bar__left">
                <span className="qm__price-bar__label">
                  {model === "monthly" ? t("qm_total_label_monthly") : t("qm_total_label")}
                </span>
